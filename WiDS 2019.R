# This is the set of commands used in the WiDS 2019 
# Statistical Learning in R workshop.
...
# Just for grins, see the results using the training set.
...
# We will use all of the Boston Housing data and won't worry
# about testing and training sets.
...
# Use different linear models. How are the results?
